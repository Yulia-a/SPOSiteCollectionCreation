...
namespace Contoso.Provisioning.SiteCollectionCreationWeb
{
    public static partial class TenantExtensions
    {
        ...
        public static string CreateSiteCollection(this Tenant tenant, SiteEntity properties, bool removeFromRecycleBin = false, bool wait = true)
        {
            ...
            Uri siteGuid = new Uri(properties.Url);
            if (wait)
            {
                siteGuid = new Uri(properties.Url);
            }
        ...
        /// <returns></returns>
        public static string CreateSiteCollection(this Tenant tenant, string siteFullUrl, string title, string siteOwnerLogin,
